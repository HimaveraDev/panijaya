...
<section class="py-16 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">Galeri Proyek Kami</h1>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">Melindungi dan memperindah bangunan Anda dengan kusen premium. Berikut adalah dokumentasi instalasi terbaik kami di berbagai area.</p>
        </div>
