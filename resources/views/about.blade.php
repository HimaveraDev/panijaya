    ...
    <section class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="w-full rounded-3xl overflow-hidden shadow-2xl border-8 border-white bg-white" style="height: 500px; min-height: 500px;">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15864.237701168536!2d106.983!3d-6.236!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698c2534f315a9%3A0xc4864c297864f1e9!2sJl.%20Jend.%20Sudirman%2C%20Bekasi%2C%20Kota%20Bks%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1713175000000!5m2!1sid!2sid" 
                    width="100%" 
                    height="100%" 
                    style="border:0;" 
                    allowfullscreen="" 
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600 text-sm">Jl. Jend. Sudirman No. 123, Kota Bekasi</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600 text-sm">+62 812 3456 789</p>
